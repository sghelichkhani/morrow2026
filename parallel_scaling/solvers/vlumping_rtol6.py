# STATUS: ablation. Renamed from `vlumping` on 2026-08-29, to match its
# siblings `bjacobi_rtol6` and `gmg_rtol6` and to free the name `vlumping`
# for the shipped preset the paper recommends. This is the linear-tolerance
# arm of the tolerance ablation: the same preconditioner at ksp_rtol 1e-6
# instead of 1e-4. Run directories were renamed with it.
