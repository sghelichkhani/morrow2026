...
def build():
    lines = [
        ...
        r"theirs in applying the preconditioner rather than in forming it. "
        r"The apply share covers both the fine smoother and the coarse solve, "
        r"whose relative sizes are given for the basin in \S\ref{sec:ordinary}. "
